...
public class METAcraftItems {
	...
	private static final Item CAMPUS_LODESTONE = register("campus_lodestone", new TexturedPolymerBlockItem(METAcraftBlocks.CAMPUS_LODESTONE, new Item.Settings(), Items.STRUCTURE_VOID, 10052));
