...
public record TimestampedSmoothCameraPathConfig(TimestampedInterpolationSet<Target> targets, SmoothCameraPathTransition.CommonConfig commonConfig) implements TransitionConfig {
