...
public record StatusEffectTransitionConfig(Holder<MobEffect> effect, int amplifier, int duration, int resetInterval) implements TransitionConfig {

	public static final MapCodec<StatusEffectTransitionConfig> CODEC = RecordCodecBuilder.mapCodec(
			instance -> instance.group(
					MobEffect.CODEC.fieldOf("id").forGetter(StatusEffectTransitionConfig::effect),
					ExtraCodecs.UNSIGNED_BYTE.optionalFieldOf("amplifier", 0).forGetter(StatusEffectTransitionConfig::amplifier),
					Codec.INT.optionalFieldOf("duration", 0).forGetter(StatusEffectTransitionConfig::duration),
					ExtraCodecs.POSITIVE_INT.optionalFieldOf("reset_interval", 1).forGetter(StatusEffectTransitionConfig::resetInterval)
