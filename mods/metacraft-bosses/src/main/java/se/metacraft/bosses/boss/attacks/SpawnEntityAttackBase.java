...
public abstract class SpawnEntityAttackBase extends InstantAttack {
	...
	protected final DataPool<EntityHelper.SpawnEntry> entities;

	public SpawnEntityAttackBase(DataPool<EntityHelper.SpawnEntry> entities) {
	...
	protected void spawnEntity(
		...
		var entityData = entities.getDataOrEmpty(ctx.random());
		entityData.ifPresent(data -> EntityHelper.spawnEntity(
