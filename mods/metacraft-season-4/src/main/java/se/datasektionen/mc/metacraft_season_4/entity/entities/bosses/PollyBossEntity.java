...
public class PollyBossEntity extends ParrotEntity implements PolymerEntity, AutoAttackingBoss, RangedAttackMob {
	...
	public static final DataPool<StatusEffectEntry> EXTRA_POOL_HIT = MagicProjectile.createHitDefaults().add(
	...
	public static final DataPool<MagicProjectile.EffectEntry> EXTRA_POOL_CLOUD = MagicProjectile.createCloudDefaults().add(
	...
	public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
		...
		setVariant(Variant.YELLOW_BLUE);
