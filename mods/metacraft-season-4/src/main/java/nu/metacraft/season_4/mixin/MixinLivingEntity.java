...
import nu.metacraft.season_4.extensions.SurviveDeathExtension;
import nu.metacraft.season_4.extensions.DragExtension;
import nu.metacraft.season_4.extensions.LivingEntityExtensionsInternal;
...
public abstract class MixinLivingEntity extends Entity implements LivingEntityExtensionsInternal, DragExtension, SurviveDeathExtension {
	...
	public int computeFallDamage(int original) {
		if ((Object) this instanceof ServerPlayerEntity player) {
			return EndBossPlayerState.getInstance(player.getEntityWorld()).filter(
