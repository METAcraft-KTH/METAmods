...
import se.datasektionen.mc.metacraft_lib.condition.conditions.*;
import se.datasektionen.mc.metacraft_lib.condition.entity_sub_predicates.HealthPredicate;
import se.datasektionen.mc.metacraft_lib.condition.entity_sub_predicates.IsMovingPredicate;
import se.datasektionen.mc.metacraft_lib.condition.entity_sub_predicates.MultiSubPredicate;
